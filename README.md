...
```
  ...
  || | (mem) | |(bus)| | (audit)| |(trust)| | (inf)|       ||
  || +-------+ +-----+ +--------+ +------+ +------+       ||
  ||                                                       ||
  ||  Trust: 0.00 -------- 0.25 --- 0.50 --- 0.75 --- 1.0 ||
  ||  +0.12 correct  /  -0.22 wrong  /  asymmetric by design ||
  +=========================================================+
       |           |           |           |           |
  +----v---+  +----v---+  +----v---+  +----v---+  +----v---+
  |DELIBER.|  |DEFENSE |  |PATTERN |  | SELF   |  | MODEL  |
  |        |  |        |  |        |  |        |  |        |
  |Council |  |Specter |  | Oracle |  |Consciou|  |  Echo  |
  |Autonomi|  |        |  | Sentry |  |  sness |  |        |
  |   c    |  |        |  |        |  | Legacy |  |        |
  +--------+  +--------+  +--------+  +--------+  +--------+
                                          |
                                     +----v---+
